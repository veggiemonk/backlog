...
- **Conflict Detection**: Automatic detection and resolution of task ID conflicts in Git workflows
...
```bash
# Detect ID conflicts
backlog conflicts detect                 # Text output
backlog conflicts detect --json          # JSON output

# Resolve conflicts using different strategies
backlog conflicts resolve                          # Chronological strategy (default)
backlog conflicts resolve --strategy=auto         # Auto-renumber conflicts
backlog conflicts resolve --strategy=manual       # Manual resolution plan
backlog conflicts resolve --dry-run               # Preview changes without applying
```
...
docker run --rm -it -v $(pwd):/data -e BACKLOG_FOLDER=/data/.backlog ghcr.io/veggiemonk/backlog conflicts detect
docker run --rm -it -v $(pwd):/data -e BACKLOG_FOLDER=/data/.backlog ghcr.io/veggiemonk/backlog conflicts resolve --dry-run
